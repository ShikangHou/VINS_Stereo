#ifndef BACKEND_EIGEN_TYPES_H
#define BACKEND_EIGEN_TYPES_H
...
typedef std::vector<Vec2, Eigen::aligned_allocator<Vec2>> VecVec2; // Eigen::aligned_allocator: 为了保证内存对齐，Eigen库提供了一个专门的内存分配器Eigen::aligned_allocator
